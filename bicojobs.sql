...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06/06/2023 às 00:42
...
ALTER TABLE `servicoavaliar`
  ...
  ADD KEY `id_ofertante` (`id_ofertante`);
...
ALTER TABLE `servicoavaliar`
  ...
  ADD CONSTRAINT `servicoavaliar_ibfk_3` FOREIGN KEY (`id_ofertante`) REFERENCES `usuario` (`id`);
